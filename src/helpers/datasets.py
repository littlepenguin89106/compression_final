...
SCALE_MIN = 0.75
SCALE_MAX = 0.95
DATASETS_DICT = {"openimages": "OpenImages", "cityscapes": "CityScapes", "coco": "COCO", 
...
class COCO(BaseDataset):
    ...
    files = {"train": "train2017", "test": "test2017", "val": "val2017"}

    def __init__(self, root=os.path.join(DIR, 'data/coco/images'), mode='train', crop_size=256, 
        normalize=False, **kwargs):
        super().__init__(root, [transforms.ToTensor()], **kwargs)
